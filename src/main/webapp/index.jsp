...
<head>
    ...
    <title>员工列表</title>
    <%-- 以 / 开始的相对路径，找资源，以服务器的路径为标准(http://localhost:8888)；需要加上项目名 ( http://localhost:8888/crud ) --%>
...
<script type="text/javascript">
    ...
    // 1. 页面加载完成以后，直接去发送 ajax 请求，取到分页数据
    $(function () {
        // 去首页
        to_page(1);
    });
